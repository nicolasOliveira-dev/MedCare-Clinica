...
<body>
    ...
    <div class="form-card-container">
        ...
        <form action="../app/Http/Controllers/medicoController.php?action=update" method="post" class="form-card">
            ...
            <fieldset class="form-group-grid">
                ...
                <div class="form-field">
                    <label for="id">ID do Médico</label>
                    <div class="input-with-icon">
                        <i class="fas fa-hashtag"></i>
                        <input type="number" id="id" name="id" required placeholder="Ex: 12">
                    </div>
                </div>
